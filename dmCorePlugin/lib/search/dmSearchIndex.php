...
//    return new Zend_Search_Lucene_Search_Query_Fuzzy($term, 0.4);
    ...
    public function populate() {
        ...
        $arrayPage = array(); // tableau contenant les idDmPages effectués
        ...
        while ($pagerPage <= $pagerPageMax) {
            ...
            // lioshi: passage d'une page à l'autre impossible avec setPage... (BUG)
            $pager = $this->serviceContainer
                    ->setParameter('doctrine_pager.model', 'DmPage')
                    ->getService('doctrine_pager')
                    ->setMaxPerPage(100)
    ...
    public static function cleanText($text) {
        return trim(
                        preg_replace('|\s{2,}|', ' ', preg_replace('|\W|', ' ', dmString::strtolower(
