 ...
 *
 */
class dmDataLoad_OLD // c'est ça qu'il faut modifier, pas le nom du fichier ;-)
{
  protected
  $dispatcher,
  $i18n,
  ...
  protected function loadPermissions()
  {
    $array = array(
      ...
      'in_place_widget_edit' => 'Peut éditer les widget perso content in place'
    );
