...
catch(Exception $e)
{
  ...
  $this->logBlock('
  There is some last things you need to do :  
  -----------------------------------------------------------------
  
  1) Please run "php symfony dm:setup"
  
  2) Add host
    C:\Windows\System32\drivers\etc\hosts
    127.0.0.1       demolocal1
 
  3) Add virtualhost
    C:\wamp\bin\apache\Apache2.2.17\conf\extra\httpd-vhosts.conf

    <VirtualHost *:80>
      DocumentRoot C:/wamp/www/demoLocal1/web
      ServerName demolocal1
    </VirtualHost>
