...
elseif(dmConfig::get('site_theme_version') == 'v2'){
        ...
        if ($defaultInfos == TRUE) {
            ...
            echo _open('div', array('class' => "address", 'itemprop' =>'address', 'itemscope' =>'', 'itemtype' =>'http://schema.org/PostalAddress'));
                ...
                echo _open('span', array('class' => "itemprop telephone"));
                    echo _tag('i', array('class' => 'icon-phone value', 'itemprop' => 'telephone'), '&nbsp;').$officeInfos->getTel();
                echo _close('span');
                ...
                if ($officeInfos->getFax() != NULL) {
                    echo '&nbsp;-&nbsp;';
                    echo _open('span.faxNumber');
                        echo _tag('i', array('class' => "icon-print value", 'itemprop' => "faxNumber"), '&nbsp;').$officeInfos->getFax();
                    echo _close('span');
                }
                echo _tag('br');
    ...
    echo _tag('strong',__('Production and administrative'));
    echo _tag('br');
    echo _tag('p','15, rue de la Demi-Lune - BP 1119 - 86061 Poitiers Cedex 9<br />'._tag('i', array('class' => 'icon-phone value', 'itemprop' => 'telephone'), '&nbsp;').'05 49 60 20 60  -  '._tag('i', array('class' => "icon-print value", 'itemprop' => "faxNumber"), '&nbsp;').'05 49 01 87 08');
    echo _tag('strong',__('Director of Publication').' : ');
    echo _tag('span','Francis Morel');
    echo _tag('br');
    echo _tag('strong',__('Editor').' : ');
