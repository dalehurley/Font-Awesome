  ...
  init: function(editor)
  {
    editor.on('instanceReady', function() {
      ...
      $('#dm_page_tree a.ui-draggable').live('dragstart', function(event, ui){
        overlayid = dmCkEditorCreateOverlay(editor, $.dm.ctrl.getHref('+/dmCkEditorPerso/page/id/'));
      });
      ...
      $('#dm_media_browser li.image.ui-draggable').live('dragstart', function(event, ui) {
        overlayid = dmCkEditorCreateOverlay(editor, $.dm.ctrl.getHref('+/dmCkEditorPerso/media/id/'));
      });
