...
class dmWidgetContentImagePlusForm extends dmWidgetContentBaseMediaForm
{
  ...
  {
    return $this->getHelper()->renderPartial('widget', 'forms/dmWidgetContentImagePlus', array(
      'form' => $this,
