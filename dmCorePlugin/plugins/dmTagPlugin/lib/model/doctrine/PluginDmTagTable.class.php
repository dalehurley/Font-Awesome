...
//    $q->addSelect('(' . implode(' + ', $counts) . ') as total_num');
    $q->addSelect('(' . implode(' + ', $counts) . ') as total_num');
//    ligne du dessous mise en commentaire afin de classer les tags par ordre alphabétique
//    $q->orderBy('total_num DESC');
//    ligne du dessus mise en commentaire afin de classer les tags par ordre alphabétique
//    ligne du dessous pour classer les tags par ordre alphabétique
    $q->orderBy('name');
//    ligne du dessus pour classer les tags par ordre alphabétique
