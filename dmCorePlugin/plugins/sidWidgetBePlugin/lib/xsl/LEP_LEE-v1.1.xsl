...
<!-- LEP_LEE-v1.1.xsl, v1.1, 2011/09/19 12:30, copyright SID Presse, Arnaud GAUDIN -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
            ...
            <Document>
                ...
                <Metadata>
                    ...
                    <AnteriorityMetadata>
                        ...
                        <PublicationDate>
                            <xsl:call-template name="date_complete"><xsl:with-param name="date"><xsl:value-of select="//Element/DateCreation"/></xsl:with-param></xsl:call-template>
                        </PublicationDate>
                ...
                <Data>
                    ...
                    <Sections>
                        ...
                        <xsl:if test="string(//Element/Signature)!=''">
                            <Section>
                                <Signature><xsl:value-of select="//Element/Signature"/></Signature>
                            </Section>
                        </xsl:if>
                        <Section>
                            <MultimediaInserts>
    ...
    <xsl:template name="DocumentNature">
        <xsl:choose>
            <xsl:when test="string(//Element/Metas/Meta[@nature])"></xsl:when>
            ...
            <xsl:when test="contains($t,'ok')">
                <xsl:for-each select="*">
                    <xsl:choose>
                        ...
                        <xsl:when test="name()='tr' or name()='td' or name()='caption' or name()='tbody'">
    ...
    <xsl:template match="*" mode="tableau">
        <xsl:if test="name(.)='' and name()!='tr' and name()!='td' and name()!='caption'">
            <xsl:apply-templates />
        </xsl:if>
    </xsl:template>
    ...
    <xsl:template match="div">
        <!-- Détection des divs ayant des classes spéciales -->
        <xsl:choose>
            ...
            <xsl:when test="string(@class)='texteparagraphe'">
                <ParagrapheTexte><xsl:apply-templates /></ParagrapheTexte>
            </xsl:when>
            <xsl:when test="string(@class)='titreparagraphe' or string(@class)='intertitre'">
                <ParagrapheTitre><xsl:apply-templates /></ParagrapheTitre>
            </xsl:when>
            ...
            <xsl:for-each select="*">
                <xsl:choose>
                    <xsl:when test="name()='div' and string(@class)='titre_annotation'">
                        <AnnotationTitre><xsl:value-of select="."/></AnnotationTitre>
                    </xsl:when>
