...
class handWidgetsListArticlesBySectionByRubriqueForm extends dmWidgetPluginForm {
    ...
    protected function renderContent($attributes) {
        return $this->getHelper()->renderPartial('handWidgets', 'listArticlesBySectionByRubriqueForm', array(
            'form' => $this,
            'id' => 'sid_widget_list_articles_by_section_by_rubrique' . $this->dmWidget->get('id')
        ));
    }
