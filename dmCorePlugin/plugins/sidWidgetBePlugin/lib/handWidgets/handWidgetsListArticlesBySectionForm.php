...
class handWidgetsListArticlesBySectionForm extends dmWidgetPluginForm {
    ...
    protected function renderContent($attributes) {
        return $this->getHelper()->renderPartial('handWidgets', 'listArticlesBySectionForm', array(
            'form' => $this,
            'id' => 'sid_widget_list_articles_by_section_' . $this->dmWidget->get('id')
        ));
    }
