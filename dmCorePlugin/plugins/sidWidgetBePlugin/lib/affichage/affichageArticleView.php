...
//        $indexRender = '';
//        if ($article[0]){
//            $indexRender = stringTools::str_truncate($article[0]->chapeau, 10000); // on indexe seulement le chapeau de l'article, on peut laisse le render() complet mais cela s'avère très lent...
//        }
//        
//        return $indexRender;
//    }
