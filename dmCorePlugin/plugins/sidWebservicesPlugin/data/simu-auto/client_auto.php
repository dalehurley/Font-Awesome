...
<div id="error"><?=$errorMessages?></div>
	<div style="margin-top: 40px;"><fieldset>
		<legend>Quel type d’activité exercez-vous ?</legend>
		<span class="label"><input name="activite" id="ventes" value="ventes" <?=($activite==ventes)?"checked=\"checked\"":""?> type="radio"> Ventes de marchandises, d'objets, de fournitures, de denrées à emporter ou à consommer sur place, ou une activité de fourniture de logement</span><br />
		...
		<span class="label"><input name="activite" id="profession" value="profession" <?=($activite==profession)?"checked=\"checked\"":""?> type="radio"> Profession libérale relevant de la CIPAV</span>
		</fieldset>
	</div>		
