#!/bin/bash -
#
# File:        git-archive-all.sh from https://github.com/meitar/git-archive-all.sh
#
# Modifications: to work with git > 1.7 change git-archive into git archive annd git-submodule into git submodule
#
